...
//File containing javascript code which provides the logical interactivity for the webpage
...
router.get('/get/html', function(req, res) {
    ...
    var xml = fs.readFileSync('BlackBooksStore.xml', 'utf8'); //We are reading in the XML file
    var xsl = fs.readFileSync('BlackBooksStore.xsl', 'utf8'); //We are reading in the XSL file
...
router.post('/post/json', function(req, res) {
  ...
  function appendJSON(obj) {
    ...
    xmlFileToJs('BlackBooksStore.xml', function(err, result) {
      ...
      result.catalog.theme[obj.theme_n].book.push({'title': obj.title, 'price': obj.price, 'author': obj.author, 'genre': obj.genre}); //If your XML elements are differet, this is where you have to change to your own element names
